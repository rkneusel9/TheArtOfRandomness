...
if (len(sys.argv) == 1):
    print()
    print("darwin_static <generations> <advantage> <mutation> <good> pcg64|mt19937|minstd|urandom|rdrand|<file> <output> [<seed>]")
    print()
...
for g in range(ngen):
    ...
    #  Option to change the environment
    pass
