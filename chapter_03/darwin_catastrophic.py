#
#  file: darwin_catastrophic.py
#
#  Simulate evolution of simple organisms that need to adapt
#  to a catastrophic environmental change
#
#  RTK, 16-Apr-2022
...
if (len(sys.argv) == 1):
    print()
    print("darwin_catastrophic <generations> <advantage> <mutation> <good> <eprob> pcg64|mt19937|minstd|urandom|rdrand|<file> <output> [<seed>]")
    print()
    ...
    print("  <eprob>        -  probability of dramatic environmental change (e.g. 0.01)")
...
for g in range(ngen):
    ...
    #  Option to change the environment catastrophically
    if (rng.random() < eprob):
        environment = (16*rng.random(6)).astype("uint8")
