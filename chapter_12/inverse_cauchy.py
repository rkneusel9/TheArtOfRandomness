...
# mu=-2,gamma=1: python3 inverse_cauchy.py 10000 "-2+1*np.tan(np.pi*(u-0.5))" "1/(np.pi*1*(1+((x+2)/1)**2))" cauchy pcg64 42
...
if (len(sys.argv) == 1):
    print()
    print("inverse_cauchy <N> <ifunc> <func> <outdir> [<kind> | <kind> <seed>]")
    print()
